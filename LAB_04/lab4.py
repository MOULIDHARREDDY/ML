...
def project_feature_plot(data, numeric_columns, target_column):
    if len(numeric_columns) >= 2:
        ...
        print("Not enough numeric features to plot scatter graph.")
...
file_path = r"D:\Sem4\KBDVM\MOULI\ML\BL.SC.U4AIE24143_LAB04\Coherence_bert_cls_embeddings.csv"
target_column = "label"
...
project_feature_plot(data, numeric_columns, target_column)
